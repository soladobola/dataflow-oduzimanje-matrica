 ...
 * \param [out] outstream_result The stream should be of size ((param_N * 4) * 4) bytes.
 */
void Vectors(
	int32_t param_N,
	const uint32_t *instream_x,
	const uint32_t *instream_y,
...
typedef struct { 
	...
	const uint32_t *instream_x; /**<  [in] The stream should be of size ((param_N * 4) * 4) bytes. */
	const uint32_t *instream_y; /**<  [in] The stream should be of size ((param_N * 4) * 4) bytes. */
	uint32_t *outstream_result; /**<  [out] The stream should be of size ((param_N * 4) * 4) bytes. */
} Vectors_actions_t;
